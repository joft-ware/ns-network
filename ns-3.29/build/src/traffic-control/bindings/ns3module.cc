...
static PyMethodDef PyNs3QueueDisc_methods[] = {
    ...
    {(char *) "SetNetDevice", (PyCFunction) _wrap_PyNs3QueueDisc_SetNetDevice, METH_VARARGS|METH_KEYWORDS, "SetNetDevice(device)\n\ntype: device: ns3::Ptr< ns3::NetDevice >" },
...
static PyMethodDef PyNs3TrafficControlLayer_methods[] = {
    ...
    {(char *) "SetupDevice", (PyCFunction) _wrap_PyNs3TrafficControlLayer_SetupDevice, METH_VARARGS|METH_KEYWORDS, "SetupDevice(device)\n\ntype: device: ns3::Ptr< ns3::NetDevice >" },
